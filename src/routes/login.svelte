...
<div class="content">
	...
	{/if}
	<div class="container bg-gray-100 mt-5 flex flex-row justify-center mx-auto max-w-sm py-6 rounded-lg shadow-xl">
		<form on:submit|preventDefault={handleLogin} class="grid grid-cols-1 gap-3">
			...
			<div class="mt-3 flex flex-row justify-center max-w-md">
				<button type="submit" class="btn btn-md mr-2 w-full">Login</button>
			</div>
			<div class="mt-3 ml-0">
				<small>New user? <a href="/register" class="link">Sign up here</a></small>
			</div>
		</form>
	</div>
</div>
